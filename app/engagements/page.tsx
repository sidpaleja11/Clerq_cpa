    ...
    <div className="flex h-screen bg-[#0d0d0f] text-[#e8e8ea] font-sans overflow-hidden">
      ...
      <div className="w-[220px] flex-shrink-0 bg-[#111113] border-r border-[#1e1e22] flex flex-col py-5">
        ...
        <div className="px-3 mt-2 mb-2">
          ...
          <Link href="/engagements" className="flex items-center gap-2.5 px-2.5 py-2 rounded-[7px] text-[13.5px] bg-[#1f1d00] text-[#ffe566]">Engagements</Link>
        </div>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <div className="flex items-center justify-between px-7 py-[18px] border-b border-[#1a1a1e] bg-[#0d0d0f]">
          ...
          <button className="px-3.5 py-1.5 rounded-[7px] text-[13px] font-medium bg-[#FEED55] text-[#0d0d0f] hover:bg-[#ffe566] transition-all">
            + New Engagement
          </button>
        </div>
                            ...
                            <div className="space-y-2">
                              {eng.scope.map((item, i) => (
                                <div key={i} className="flex items-center gap-2.5">
                                  <div className="w-1.5 h-1.5 rounded-full bg-[#FEED55] flex-shrink-0" />
